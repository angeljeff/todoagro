    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    // Actualizar el estado del pedido a "Entregado" en la tabla "pedido"
                    $update_pedido_query = "UPDATE pedido SET Estado = 'Entregado' WHERE PedidoID = ?";
                    ...
                    if ($stmt) {
                        ...
                        if ($stmt->execute()) {
                            ...
                            $update_recolecta_query = "UPDATE recolectaplantas SET CantidadRecolectada = CantidadRecolectada - ?, SobranteBandeja = SobranteBandeja - ? WHERE RecolectaID = ?";
                            ...
                            if ($stmt) {
                                ...
                                $stmt->bind_param("sss", $cantPlantulas, $cantBandejasDesocupadas, $RecolectaID);
                                if ($stmt->execute()) {
