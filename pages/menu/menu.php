...
<aside class="main-sidebar sidebar-dark-teal elevation-4" >
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../img/logo.webp" alt="Logo TODOAGRO" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        foreach ($allowedModules as $module) {
          ...
          if ($module == 'Dashboard') {
            ...
            echo '<li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="../UI/Seguridad-roles-permisos.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Rol y Permiso</p>
                      </a>
                    </li>
            ...
            echo '<li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="../UI/Administrativo-usuarios.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Empleado</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="../UI/Administrativo-clientes.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Cliente</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="../UI/Administrativo-productos-plantulas.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Producto plántulas</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="../UI/Administrativo-variedad.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Tipo y variedad de plántulas - Bandejas</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="../UI/Administrativo-mesadas.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Mesones</p>
                      </a>
                    </li>
            ...
            echo '<li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="../UI/Pedido.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Agregar Pedido</p>
                      </a>
                    </li>
            ...
            echo '<li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="../UI/Planificacion-pedido.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Agregar Planificación</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="../UI/Planificación-listado.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
            ...
            echo '<li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="../UI/Seguimiento-siembra.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Siembra</p>
                      </a>
                    </li>
                    ...
                    <li class="nav-item">
                      <a href="../UI/Seguimiento-trasplantes.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
          ...
          } elseif ($module == 'Reservas') {
            echo '<li class="nav-item">
                  <a href="#" class="nav-link">
                    <i class="nav-icon fas fa-table"></i>
                    <p>Almacenaje y reservas
                    <i class="fas fa-angle-left right"></i>
                    </p>
                  </a>
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="../UI/Seguimiento-almacenaje.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Reservas</p>
                      </a>
                    </li>
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="../UI/Seguimiento-listado-reserva.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
            ...
            echo '<li class="nav-header">Entregados</li>
                  <li class="nav-item">
                  <a href="../UI/Seguimiento-pedido-listo.php" class="nav-link">
                    <i class="nav-icon far fa-calendar-alt"></i>
                    <p>Enviar Entrega</p>
                  </a>
                  </li>';
            echo '<li class="nav-item">
                  <a href="../UI/Seguimiento-listado-pedido.php" class="nav-link">
